  ...
  <nav class="bg-white/30 dark:bg-gray-700/30 fixed w-full backdrop-blur-md">
    ...
    >
      ...
      <div class="hidden sm:flex flex-row w-auto items-center grow">
        <a class="p-3 dark:text-white hover:underline text-gray-700" href="/works">Works</a>
        <a class="p-3 dark:text-white hover:underline text-gray-700" href="/contact">Contact</a>
        <a
          target="_blank"
          class=" inline-flex items-center pl-2 p-3 text-gray-700 dark:text-white hover:underline"
          style="gap: 4px"
