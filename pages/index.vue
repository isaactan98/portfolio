  ...
  <div class="grid p-5 w-full sm:m-auto sm:max-w-3xl">
    <div class="mb-16 sm:m-0 w-full grid gap-8">
      <div class="min-h-full w-full">
        <div class="bg-zinc-500/50 dark:bg-stone-500/50 backdrop-blur text-center p-3 rounded-lg dark:text-white">
        ...
        <div class="sm:flex mt-6">
          ...
          <div class="mt-4 flex-shrink-0 flex justify-center sm:block sm:mt-0 sm:ml-6">
            <div
              class="w-[100px] h-[100px] inline-block overflow-hidden rounded-full border-white border-2 border-solid relative">
              <img src="~/assets/images/me.png" alt="Me" class="absolute -top-4" />
            </div>
          </div>
        </div>

        <div class="mb-12" style="opacity: 1; transform: none">
          <h3 class="leading-5 text-2xl my-5 underline underline-offset-4 decoration-4 dark:text-white">
            About Me
          </h3>
          <div v-if="aboutMe != null">
            <p class="text-justify indent-4 dark:text-white"
              v-html="aboutMe.fields.aboutMe.content[0].content[0].value"></p>
          </div>
          <div class="min-h-[30vh] w-full border-none dark:text-white btn loading" v-else></div>
        </div>

        <div class="mb-12" style="opacity: 1; transform: none">
          <h3 class="leading-5 text-2xl text-justify my-5 underline underline-offset-4 decoration-4 dark:text-white">
            Bio
          </h3>
        ...
        <div class="mb-12">
          ...
          <div v-if="techStack != null" class="relative">
            ...
            <div class="absolute border-l-2 border-zinc-500 top-0 left-1/2 md:left-1/3" id="lang_section">
              <div class="absolute top-1/2 ml-8 dark:text-white text-2xl font-bold stacks stacks-t">
                Language
              </div>
            </div>

            <div
              class="block absolute h-[10%] md:h-[5%] w-1/4 left-1/2 md:left-1/3 md:border-b-2 border-l-2 border-zinc-500 md:rounded-bl-full"
              id="first_section"></div>

            <div
              class="hidden md:block absolute h-[6%] left-1/2 md:right-1/3 md:border-t-2 border-r-2 border-zinc-500 md:rounded-tr-full"
              id="second_section"></div>

            <div class="absolute border-r-zinc-500 border-r-2 left-1/2 md:right-1/3 top-1/2 sm:top-1/3"
              id="framework_section">
              <div class="dark:text-white text-2xl font-bold absolute top-1/2 right-0 mr-8 stacks stacks-t">
                Framework
              </div>
            </div>
          </div>
  ...
  mounted() {
    ...
    client
      ...
      .then(() => {
        ...
        lang_section.style.minHeight = `${(this.counter.lang / (this.counter.lang + this.counter.framework)) *
          100 -
          5
          }%`;

        framework_section.style.top = `${(this.counter.lang / (this.counter.lang + this.counter.framework)) *
          100 +
          5
          }%`;

        framework_section.style.minHeight = `${(this.counter.framework /
        ...
        first_section.style.top = `${(this.counter.lang / (this.counter.lang + this.counter.framework)) *
          100 -
          5
          }%`;

        second_section.style.top = `${(this.counter.lang / (this.counter.lang + this.counter.framework)) *
          100 -
          0.28
          }%`;
